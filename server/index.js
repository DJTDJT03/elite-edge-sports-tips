...
app.post('/api/chat', (req, res) => {
  ...
  if (lower.includes('best tip') || lower.includes('today') || lower.includes('pick')) {
    ...
    response = 'Premium membership gives you access to all tips, full analysis, and priority alerts. Plans start at just \u00a329.99/month or save with our annual plan at \u00a3249.99/year. Click the Upgrade button to get started — you can cancel anytime.';
