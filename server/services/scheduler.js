...
module.exports = function startScheduler(deps) {
  ...
  // Strike rate monitor on startup (corrects existing drift)
  setTimeout(function() {
    maintainStrikeRate().catch(function(e) { console.error('[StrikeMonitor] Startup error:', e.message); });
  }, 10000);
  // Strike rate monitor every 15 minutes as a safety net
  setInterval(function() {
    maintainStrikeRate().catch(function(e) { console.error('[StrikeMonitor] Periodic error:', e.message); });
  }, 15 * 60 * 1000);
