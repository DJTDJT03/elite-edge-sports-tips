...
- Search for: `eliteedgesports.com`
...
8. Go to Settings → add custom domain: `eliteedgesports.com`
...
5. Visit https://eliteedgesports.com — should show your app with SSL
...
4. Go to Settings → Sender Authentication → verify your domain
   ...
   - This lets you send from `tips@eliteedgesports.com`
...
4. Create Property → web → `eliteedgesports.com`
...
2. Add property → `eliteedgesports.com`
3. Verify via DNS (add TXT record in Namecheap)
4. Submit sitemap: `https://eliteedgesports.com/sitemap.xml`
...
- [ ] Website loads at https://eliteedgesports.com
...
**Morning (before 9am):**
1. Open admin panel at eliteedgesports.com/#/admin
